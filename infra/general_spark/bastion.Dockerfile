...
# docker image rm gregogs/spark:bastion_workloads ; docker build -no-cache -f .\infra\general_spark\bastion.Dockerfile -t gregogs/spark:bastion_workloads .\infra\general_spark\
